...
export default function MobileMenu({
  ...
  return (
    <div
      ...
      className="fixed inset-0 z-[100] bg-[var(--bg-elevated)] overflow-y-auto"
      style={{ fontFamily: HELVETICA }}
    >
      {/* ───────── Header (height 80) ───────── */}
      <div
        className="sticky top-0 bg-[var(--bg-elevated)] flex items-end gap-3 px-4 pb-2 pt-9 box-border z-10"
        style={{ height: 80 }}
      >
        <a
          href="/"
        ...
        <div
          className="flex flex-col flex-1 ml-2 text-[#162E51]"
          style={{
            width: 104,
            minWidth: 104,
            height: 31,
        ...
        <button
          ...
          onClick={onClose}
          className="w-8 h-8 flex items-center justify-center text-[#17202A] hover:text-[#162E51] transition-colors"
        >
      ...
      <div className="px-4 pt-5 pb-12 flex flex-col">
          ...
          {NAV.map((item) => {
            ...
            return (
              <a
                ...
                className="block text-[#17202A] hover:text-[#162E51] transition-colors uppercase"
                style={{
                  fontFamily: HELVETICA,
                  fontSize: 24,
                  fontWeight: 400,
        ...
        <a
          ...
          className="relative flex items-center justify-center w-full text-center bg-[#162E51] text-[var(--text-primary)] uppercase rounded hover:brightness-110 transition gap-2"
          style={{
            height: 56,
            fontFamily: HELVETICA,
            fontSize: 14,
        ...
        <div className="mt-8">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              {socials?.instagram?.enabled !== false ? (
                <a
                  ...
                  className="rounded-full border border-[#D8D0C6] flex items-center justify-center text-[#17202A] hover:text-[#162E51] hover:border-[#162E51] transition-colors"
            ...
            <button
              type="button"
              onClick={() => onLangChange && onLangChange(langKey === 'en' ? 'ru' : 'en')}
              data-testid="mobile-menu-lang"
              className="flex items-center justify-between text-[#17202A] hover:text-[#162E51] transition-colors"
              style={{
                width: 50,
                height: 17,
                padding: 0,
