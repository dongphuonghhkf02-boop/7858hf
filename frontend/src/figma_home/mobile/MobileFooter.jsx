...
export default function MobileFooter({ lang: langProp }) {
  ...
  // Dec 2026: Viber retired → Telegram primary. Channel URL falls back to
  // socials.telegram.url, then SOCIAL_DEFAULTS, so legacy admin payloads
  // pointing at viber_community.url still serve the Telegram CTA gracefully.
  ...
  return (
    ...
    >
      ...
      <div data-testid="footer-phone-block" style={{ position: 'absolute', top: 141, left: 0, right: 0, textAlign: 'center' }}>
        <div style={{ fontWeight: 500, fontSize: 12, lineHeight: '14px', color: '#17202A', letterSpacing: 0 }}>
        ...
        <div style={{ marginTop: 16, display: 'flex', flexDirection: 'column', gap: 4 }}>
          {phones.map((p, i) => (
            <a
              ...
              style={{ fontWeight: 500, fontSize: 18, lineHeight: '22px', color: '#162E51', textDecoration: 'none' }}
            >
              {p}
            </a>
          ))}
      ...
      <button
        ...
        style={{
          ...
          background: 'transparent', color: '#162E51', border: '1px solid #162E51',
        ...
        onMouseEnter={(e) => { e.currentTarget.style.background = '#162E51'; e.currentTarget.style.color = '#FFFFFF'; }}
      ...
      <div data-testid="footer-address-block" style={{ position: 'absolute', top: 386.6, left: 16, right: 16 }}>
        <div style={{ fontWeight: 500, fontSize: 12, lineHeight: '14px', color: '#17202A' }}>{t('mobileFooterAddress') || 'Address:'}</div>
        <div style={{ marginTop: 16, fontWeight: 500, fontSize: 18, lineHeight: '24px', color: '#162E51' }}>
          {addresses.map((a, i) => (
      ...
      >
        ( {t('mobileFooterWorkingHours') || 'Availability'}: {(() => {
          // 24 / 7 policy — bypass admin `working_hours` override; only
          // explicit per-language `working_hours_<lang>` key wins.
      ...
      {/* 7a — JOIN TELEGRAM CHANNEL (replaces Viber community) */}
      <div
      ...
      >
        <span style={{ fontWeight: 500, fontSize: 12, lineHeight: '15px', color: '#17202A', letterSpacing: 0 }}>
          {telegramLabel}
        </span>
        <a
          href={telegramUrl}
        ...
        >
          <img src="/figma/ic-round-telegram.svg" alt="" width={42} height={42} style={{ display: 'block' }} />
        </a>
      </div>
      ...
      >
        <span style={{ fontWeight: 500, fontSize: 12, lineHeight: '14px', color: '#17202A', letterSpacing: 0 }}>
          {t('mobileFooterSocialMedia') || 'Social media:'}
        </span>
        <div style={{ marginTop: 32, display: 'flex', alignItems: 'center', gap: 18 }}>
          <a href={resolvedSocialUrl('instagram')} target="_blank" rel="noreferrer noopener" aria-label="Instagram" data-testid="footer-social-instagram" style={{ display: 'inline-flex' }}>
            <img src="/figma/ri-instagram-line.svg" alt="" width={28} height={28} style={{ display: 'block' }} />
          </a>
          <a href={resolvedSocialUrl('facebook')} target="_blank" rel="noreferrer noopener" aria-label="Facebook" data-testid="footer-social-facebook" style={{ display: 'inline-flex' }}>
            <img src="/figma/ic-twotone-facebook.svg" alt="" width={28} height={28} style={{ display: 'block' }} />
          </a>
          <a href={resolvedSocialUrl('whatsapp')} target="_blank" rel="noreferrer noopener" aria-label="WhatsApp" data-testid="footer-social-whatsapp" style={{ display: 'inline-flex' }}>
            <img src="/figma/ic-whatsapp.svg" alt="" width={28} height={28} style={{ display: 'block' }} />
          </a>
          <a href={resolvedSocialUrl('avito')} target="_blank" rel="noreferrer noopener" aria-label="Avito" data-testid="footer-social-avito" style={{ display: 'inline-flex' }}>
            <img src="/figma/ic-avito.svg" alt="" width={28} height={28} style={{ display: 'block' }} />
          </a>
        </div>
      </div>
        ...
        {[
          ...
          return (
            <a
              ...
              style={{ fontWeight: 400, fontSize: 16, lineHeight: '20px', letterSpacing: '0.04em', color: '#17202A', textDecoration: 'none', transition: 'color 150ms ease' }}
        ...
        {[
          ...
          <button
            ...
            style={{
              ...
              color: '#17202A', textDecoration: 'none', whiteSpace: 'nowrap', transition: 'color 150ms ease',
            }}
            onMouseEnter={(e) => { e.currentTarget.style.color = '#162E51'; }}
            onMouseLeave={(e) => { e.currentTarget.style.color = '#FFFFFF'; }}
          >
      ...
      >
        <a
          ...
          style={{ fontWeight: 500, fontSize: 12, lineHeight: '14px', letterSpacing: '0.04em', color: '#17202A', textDecoration: 'none', whiteSpace: 'nowrap', transition: 'color 150ms ease' }}
          onMouseEnter={(e) => { e.currentTarget.style.color = '#162E51'; }}
          onMouseLeave={(e) => { e.currentTarget.style.color = '#FFFFFF'; }}
        >
          / Website design - O.la /
      ...
      <div
        ...
        style={{ position: 'absolute', bottom: 19, left: 72, right: 72, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: 7, color: '#17202A' }}
      >
        <img
          ...
          aria-hidden="true"
        />
        <span style={{ fontWeight: 500, fontSize: 10, lineHeight: '14px', letterSpacing: '0.04em', color: '#17202A', whiteSpace: 'nowrap' }}>
          {new Date().getFullYear()}. {t('mobileFooterCopyright') || 'All right reserved. DM AUTO'}
        </span>
      </div>
    </footer>
  );
