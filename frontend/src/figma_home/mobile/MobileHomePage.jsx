...
/**
 * MobileHomePage — mobile version of the DM Auto homepage matching the
...
const FALLBACK_FAQ = {
  en: [
    { question: 'How to choose and buy a car from Germany?' },
  ...
  bg: [
    { question: 'Как выбрать и купить автомобиль из Германии?' },
    ...
    { question: 'Как я могу отслеживать свой заказ?' },
  ],
};
...
const FALLBACK_REVIEWS = {
  en: [
    ...
    { name: 'Dimitar', rating: 5, text: 'Bought a German SUV through MILD — they really know their stuff. Great value for money.' },
  ],
  bg: [
    { name: 'Джордж', rating: 5, text: 'Мне понравился подход — четко, прозрачно, без сюрпризов. Машина была бюджетной и они всегда были в наличии.' },
    { name: 'Димитар', rating: 5, text: 'Покупал через МИЛД немецкий джип - они действительно знают свое дело. Отличное соотношение цены и качества.' },
  ],
};
...
const I18N = {
  en: {
    ...
    searchForCarsFromAmericaKorea: 'Source cars from Europe via mail.de',
    mostPopularBrands: 'Popular brands',
    ...
    fillOutApplication: 'Tell us what you\u2019re looking for and we\u2019ll find the best match across European auctions \u2014 delivered straight to your customs.',
    dreamCtaEyebrow: '// Let\u2019s get started',
    dreamCtaFeature1: 'No prepayment',
    dreamCtaFeature2: 'Free consultation',
    dreamCtaFeature3: 'Reply within 24h',
    ...
    registrationAddressDefault: 'Belarus / Russia — by appointment',
    ...
    allRightReserved: 'All right reserved. DM AUTO',
    ...
    costToBulgaria: 'turnkey cost (BY / RU):',
  ...
  ru: {
    ...
    searchForCarsFromAmericaKorea: 'Подбор авто из Европы через mail.de',
    mostPopularBrands: 'Популярные бренды',
    otherBrandsPlus: 'Другие бренды +',
    hideBrandsMinus: 'Скрыть знаки −',
    topVehiclesDeals: 'Лучшие предложения автомобилей',
    ofTheWeek: 'недели',
    thousandsOfListings: 'Тысячи объявлений.',
    onlyBestMakeCut: 'Только лучшие проходят.',
    updatedWeekly: 'Обновляется еженедельно',
    wantToDrive: '\u0425\u043e\u0442\u0438\u0442\u0435 \u0432\u043e\u0434\u0438\u0442\u044c',
    yourDreamCar: '\u0430\u0432\u0442\u043e \u0441\u0432\u043e\u0435\u0439 \u043c\u0435\u0447\u0442\u044b?',
    fillOutApplication: '\u0420\u0430\u0441\u0441\u043a\u0430\u0436\u0438\u0442\u0435, \u0447\u0442\u043e \u0432\u044b \u0438\u0449\u0435\u0442\u0435 \u2014 \u043c\u044b \u043f\u043e\u0434\u0431\u0435\u0440\u0451\u043c \u043b\u0443\u0447\u0448\u0438\u0439 \u0432\u0430\u0440\u0438\u0430\u043d\u0442 \u043d\u0430 \u0430\u0443\u043a\u0446\u0438\u043e\u043d\u0430\u0445 \u0421\u0428\u0410, \u041a\u043e\u0440\u0435\u0438 \u0438 \u0415\u0421 \u0438 \u043f\u0440\u0438\u0432\u0435\u0437\u0451\u043c \u043d\u0430 \u0432\u0430\u0448\u0443 \u0442\u0430\u043c\u043e\u0436\u043d\u044e.',
    dreamCtaEyebrow: '// \u041d\u0430\u0447\u043d\u0451\u043c',
    dreamCtaFeature1: '\u0411\u0435\u0437 \u043f\u0440\u0435\u0434\u043e\u043f\u043b\u0430\u0442',
    dreamCtaFeature2: '\u0411\u0435\u0441\u043f\u043b\u0430\u0442\u043d\u0430\u044f \u043a\u043e\u043d\u0441\u0443\u043b\u044c\u0442\u0430\u0446\u0438\u044f',
    dreamCtaFeature3: '\u041e\u0442\u0432\u0435\u0442 \u0432 \u0442\u0435\u0447\u0435\u043d\u0438\u0435 24\u0447',
    ...
    workingHoursDefault: 'Пн - Пт, 10.00 - 19.00',
    registrationAddress: 'Адрес регистрации:',
    registrationAddressDefault: 'Беларусь / Россия — по записи',
    socialMedia: 'Социальные сети:',
    joinOurGroupHottest: 'Присоединяйтесь к нашей группе и получайте самые выгодные предложения',
    navCatalog: 'КАТАЛОГ',
    ...
    legalCookies: 'КУКИ-ФАЙЛЫ',
    allRightReserved: 'Все права защищены. БИБИ МАШИНЫ',
    ...
    searchBrand: 'Ищу бренд...',
    noBrandsFound: 'Бренды не найдены',
    // Filter chips / pricing
    priceRange: 'Ценовой диапазон',
    proposalsLabel: 'Предложения',
    // Top deals
    moreVehiclesPlus: 'Больше автомобилей +',
    lessVehiclesMinus: 'Меньше машин —',
    moreDetails: 'Подробнее',
    tradingDate: 'Дата аукциона',
    purchasePriceLabel: 'Цена покупки',
    mileageLabel: 'Пробег',
    engineLabel: 'Двигатель',
    driveLabel: 'Водить машину',
    estimatedFinal: 'Предполагаемый финал',
    costToBulgaria: 'цена в Болгарию:',
    driveAllWheel: 'Все колеса',
    enginePetrol: 'Бензин',
    engineDiesel: 'Дизель',
    engineHybrid: 'Гибридный',
    engineElectric: 'Электрический',
    // Calculator block
    ...
    searchByVin: 'Поиск по VIN или номеру партии',
    ...
    areOurPriority: 'наш приоритет',
    beforeAndAfter: 'До и после',
    ourClientsSay: 'Что говорят наши клиенты',
    whatCustomersSay: 'Что говорят клиенты',
    whenTheyWorkWithUs: 'когда они работают с нами',
    googleReviews: 'Обзор Google',
    websiteDesignBy: 'Дизайн сайта - О.ла',
    websiteMadeWith: 'Сайт создан с помощью Eva-X.',
  },
};
...
export default function MobileHomePage() {
  ...
  const addresses = (Array.isArray(_langAddrList) && _langAddrList.length > 0)
    ...
    : (langKey === 'ru'
        ? [
            'Болгария, София, Драгалевци, бул. Витоша, 230',
            'Болгария, София, Бул. Болгария. № 81',
          ]
  ...
  const reviews = reviewItems.length
    ? reviewItems.map((r) => ({
        ...
        name: (langKey === 'ru' ? (r.name_ru || r.name) : (r.name_en || r.name)) || '',
        rating: r.rating || 5,
  ...
  // Dec 2026: Viber retired → Telegram primary. Old viberCommunity payload
  // still supported as URL fallback for legacy admin configs.
  const telegramSocial = siteInfo?.footer?.socials?.telegram || {};
  const telegramLabel =
    fmtLang(telegramSocial[`label_${langKey}`] || telegramSocial.label, langKey)
    || (langKey === 'ru'
      ? 'Подпишитесь на Telegram-канал и пишите команде'
      : 'Join our Telegram channel and chat with the team');
  const telegramUrl =
    telegramSocial.url
    || viberCommunity.url
    || 'https://t.me/dmauto_official';
  // Convenience aliases kept under the original names to minimise diff in
  // pixel-positioned blocks below.
  ...
  return (
    <div
      className="bg-[var(--bg-base)] text-[var(--text-primary)] min-h-screen"
      style={{
    ...
    >
      ...
      <section className="relative pt-6 overflow-hidden">
        ...
        <div
          className="text-[var(--text-primary)] text-center uppercase mx-auto"
          style={{
            fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
            fontWeight: 500,
            fontSize: 12,
        ...
        <div className="mt-3 text-center">
          <AnimatedHeading
            as="div"
            text={heroL1}
            className="uppercase text-[var(--accent-brand)]"
            style={{
              fontFamily: "'Helvetica Neue', Helvetica, Arial, sans-serif",
              fontWeight: 700,
              fontSize: 40,
      ...
      {/* ═════════ WHY YOU PAY LESS — AND GET MORE (Mobile V3) ═════════
           Editorial cream section with UVP centerpiece + 4 pull-quote
           advantages (5-step inspection lives in "How we deliver" above).
       ═════════════════════════════════════════════════════════════════ */}
      <MobileWhyPayLess />

      {/* ═════════ DREAM CAR CTA (Mobile V3) ═════════
           Full-bleed cinematic banner. No DM Auto / BIBI logo overlay.
           Copy uses neutral "European auctions" wording.
       ════════════════════════════════════════════════════════════════ */}
      <section
        ...
        style={{
          ...
          backgroundImage: 'url(/mobile/young-woman-with-salesman-carshowroom-1@2x.png)',
          backgroundSize: 'cover',
          backgroundPosition: 'center right',
          backgroundRepeat: 'no-repeat',
          color: '#F5F0E8',
          fontFamily: "'Mazzard H', 'Mazzard', system-ui, -apple-system, sans-serif",
      ...
      >
        {/* Navy + amber overlay so the copy stays crisp on top of the photo */}
        <div
          aria-hidden="true"
          style={{
            position: 'absolute',
            inset: 0,
            background:
              'radial-gradient(420px 360px at 12% 90%, rgba(254, 174, 0, 0.20), transparent 60%),' +
              'linear-gradient(180deg, rgba(11, 24, 48, 0.30) 0%, rgba(11, 24, 48, 0.78) 55%, rgba(11, 24, 48, 0.94) 100%)',
            zIndex: 1,
          }}
        />
        <div
        ...
        >
          ...
          >
            <AnimatedHeading as="span" text={t.wantToDrive} style={{ display: 'block' }} />
            <AnimatedHeading
              as="span"
              text={t.yourDreamCar}
              baseDelay={(t.wantToDrive || '').replace(/\s/g, '').length * 28}
              style={{ display: 'block', color: '#FEAE00' }}
            />
          </h2>
          ...
          >
            {[t.dreamCtaFeature1, t.dreamCtaFeature2, t.dreamCtaFeature3].map((label) => (
              <li
                key={label}
                style={{
                  display: 'inline-flex',
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    height: 14,
                    borderRadius: '50%',
                    background: 'rgba(254, 174, 0, 0.22)',
                    alignItems: 'center',
          ...
          <button
            ...
            style={{
              ...
              cursor: 'pointer',
              boxShadow:
                '0 14px 28px -10px rgba(254, 174, 0, 0.55),' +
                '0 6px 14px -6px rgba(15, 31, 54, 0.45)',
      ...
      >
        {/* 1 — LOGO DM Auto — natural aspect 1060:206 (~5.15:1), height 43.7 (-5%) */}
        <img
        ...
        <button
          ...
          onMouseEnter={(e) => { e.currentTarget.style.background = '#162E51'; e.currentTarget.style.color = '#F5F0E8'; }}
          onMouseLeave={(e) => { e.currentTarget.style.background = 'transparent'; e.currentTarget.style.color = '#162E51'; }}
        >
          {t.getInTouch}
        </button>
        ...
        >
          ( {t.workingHours}: {(lang === 'ru'
              ? siteInfo?.footer?.contacts?.working_hours_ru
        ...
        >
          ...
          <div>
            {(lang === 'ru'
              ? siteInfo?.footer?.contacts?.registration_address_ru
        ...
        >
          {[
            ...
            <a
              ...
              onMouseEnter={(e) => { e.currentTarget.style.color = '#162E51'; }}
              onMouseLeave={(e) => { e.currentTarget.style.color = '#17202A'; }}
            >
              {it.label}
            </a>
          ))}
          ...
          {[
            ...
            <button
              ...
              style={{
                ...
                fontFamily: "'Mazzard', 'Mazzard H', system-ui, -apple-system, sans-serif",
                fontWeight: 500,
                fontSize: lang === 'ru' ? 11 : 12,        /* BG "ПОЛИТИКА ЗА ПОВЕРИТЕЛНОСТ" is ~25% wider — drop one step so 3 pills fit the 328 px row */
                lineHeight: '14px',
                letterSpacing: lang === 'ru' ? '0.02em' : '0.04em',
                color: '#17202A',
                textDecoration: 'none',
                whiteSpace: 'nowrap',
                transition: 'color 150ms ease',
    ...
    <label className="block">
      ...
      <div className="relative">
        <input
          ...
          inputMode={inputMode}
          maxLength={maxLength}
          className="w-full bg-transparent border border-[var(--border-default)] rounded text-[var(--text-primary)] focus:outline-none focus:border-[var(--accent-brand)]"
          style={{
            height: 45,
            paddingLeft: 16,
            paddingRight: 36,
        ...
        <span
          aria-hidden
          className="absolute pointer-events-none text-[var(--text-primary)]/80"
...
const MOBILE_FEATURED_BRANDS = [
  { slug: 'mercedes',   name: 'Mercedes-Benz', src: '/figma/brands/mercedes.webp'   },
  { slug: 'jeep',       name: 'Jeep',          src: '/figma/brands/jeep.webp'       },
  { slug: 'toyota',     name: 'Toyota',        src: '/figma/brands/toyota.webp'     },
  { slug: 'bmw',        name: 'BMW',           src: '/figma/brands/bmw.webp'        },
  { slug: 'hyundai',    name: 'Hyundai',       src: '/figma/brands/hyundai.webp'    },
  { slug: 'volkswagen', name: 'Volkswagen',    src: '/figma/brands/volkswagen.webp' },
];

const MOBILE_EXTRA_BRANDS = [
  'audi','ford','honda','kia','lexus','mazda',
  'nissan','porsche','tesla','chevrolet','dodge','cadillac',
  'acura','alfa-romeo','aston-martin','bentley','buick',
  'chrysler','ferrari','fiat','genesis','gmc',
  'hummer','infiniti','international','isuzu','jaguar',
  'lamborghini','land-rover','lincoln','lotus','maserati',
  'mg','mini','mitsubishi','polestar',
  'pontiac','ram','rolls-royce','saab','smart','subaru',
  'suzuki','volvo','yamaha',
].map((slug) => ({
  slug,
  name: slug
...
function MobileSearchFromAmericaKorea({ t }) {
  ...
  return (
    ...
    >
      ...
      <AnimatedHeading
        as="h2"
        text={t?.searchForCarsFromAmericaKorea || 'Source cars from Europe via mail.de'}
        style={{
          margin: '0 0 28px 0',
          textAlign: 'center',
          fontFamily: FONT,
      ...
      >
        ...
        >
          {t?.mostPopularBrands || 'Popular brands'}
        </div>
...
function MobileTopVehicleDeals({ t }) {
  ...
  // Apply DM Auto tilt-parallax to the single visible deal card. Lives on the
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: '#162E51' }}>{t?.thousandsOfListings || 'Thousands of listings.'}</span>
        <br />
        <span style={{ color: '#17202A' }}>{t?.onlyBestMakeCut || 'Only the best make the cut.'}</span>
        <br />
        <span style={{ color: '#17202A' }}>{t?.updatedWeekly || 'Updated weekly'}</span>
      </div>
      ...
      >
        ...
        >
          {VEHICLE_TYPES.map((v) => {
            ...
            const fg = active ? '#F5F0E8' : '#17202A';
            const bg = active ? '#162E51' : 'transparent';
            return (
              <button
                key={v.id}
                type="button"
      ...
      >
        ...
        <span style={{ color: '#17202A', whiteSpace: 'nowrap' }}>{t?.proposalsLabel || 'Proposals'} - {proposals}</span>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'stretch' }}>
          ...
          >
            <dt style={{ color: '#17202A', fontWeight: 500 }}>{t.mileageLabel}</dt>
            <dd style={{ margin: 0, color: '#162E51', fontWeight: 700, textAlign: 'right' }}>{current.mileage}</dd>
            <dt style={{ color: '#17202A', fontWeight: 500 }}>{t.engineLabel}</dt>
            <dd style={{ margin: 0, color: '#162E51', fontWeight: 700, textAlign: 'right' }}>{translateEngine(current.engine, t)}</dd>
            <dt style={{ color: '#17202A', fontWeight: 500 }}>{t.driveLabel}</dt>
            <dd style={{ margin: 0, color: '#162E51', fontWeight: 700, textAlign: 'right' }}>{translateDrive(current.drive, t)}</dd>
          </dl>
        </div>
        ...
        <div style={{ display: 'flex', gap: 12, alignItems: 'flex-end', marginTop: 14 }}>
          <div style={{ flex: '1 1 0', minWidth: 0 }}>
            ...
            <div style={{ fontFamily: FONT, fontWeight: 700, fontSize: 12, lineHeight: '16px', color: '#162E51', marginTop: 6 }}>
              {current.finalCost}
            </div>
          </div>
          <button
      ...
      <div style={{ width: 336, maxWidth: '100%' }}>     {/* 360 − 12 L − 12 R = 336 (user spec: 12 L/R) */}
        ...
        <button
          ...
          style={{
            ...
            background: '#162E51', color: '#F5F0E8', border: 'none', borderRadius: 4,
  ...
  return (
    <div style={{ position: 'relative' }}>
      <select
        ...
        style={{
          width: '100%', height: 48, background: '#F5F0E8', border: '1px solid #2a2a28',
...
function MobileHowWeWork() {
  ...
  const L = isRu
    ? {
        ...
        weWorkForEachClient: 'Мы работаем для каждого клиента',
        dependingOnBudget: 'согласно бюджету',
        ...
        plans: [
          {
            key: 'standard',
            tag: 'Стандартный',
            desc: 'Найти, осмотреть, предложить, купить\доставить в Болгарию.',
            accent: 'Остальные шаги\nвы делаете сами.',
          },
          {
            key: 'turnkey',
            tag: 'На ключе',
            desc:
              'Полный сервис без вашего участия:\nпоиск, проверка, покупка,\nдоставка, адаптация, техническая\nпроверка и регистрация.',
            accent: 'Вы получаете готовый к эксплуатации автомобиль.',
          },
          {
            key: 'sourcing',
            tag: 'Найти + доставка\n+ поддержка',
            desc: 'Поиск, проверка, покупка\отправка.',
            accent:
              'Вы сами заботитесь о регистрации —\nмы связываем вас с проверенными\nпартнерами по обслуживанию.',
          },
        ],
      }
    : {
  ...
  // Shared DM Auto tilt-parallax for the 3 plan cards (Standard / Turnkey /
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ color: '#162E51', display: 'block' }}>
            {L.weWorkForEachClient}
          </span>
          <span style={{ color: '#17202A', display: 'block', marginTop: 2 }}>
            {L.dependingOnBudget}
          </span>
        </p>
      </div>
      ...
      >
        {PLANS.map((p) => {
          const bg = p.yellow ? '#162E51' : '#0E0E0E';
          const border = p.yellow ? 'none' : '1px solid #FEAE00';
          const numColor = p.yellow ? 'rgba(0,0,0,0.55)' : '#162E51';
          const titleColor = p.yellow ? '#F5F0E8' : '#162E51';
          const descColor = p.yellow
            ? '#F5F0E8'
            : p.key === 'sourcing'
              ? '#17202A'
              : '#17202A';
          const accentColor = p.yellow ? '#F5F0E8' : '#162E51';
...
function MobileHowToBuyTurnkey() {
  ...
  const L = isRu
    ? {
        titleLine1: 'Как купить',
        titleLine2: 'ключ от машины',
        joinOurGroup: 'Присоединяйтесь к нашей группе',
        pickUpTheCar: 'Возьми машину',
        steps: [
          'Мы отправляем запрос',
          'Обсуждаем детали',
          'Мы ищем машину',
          'Мы покупаем и отправляем в\nевропейский порт.',
          'Таможенное оформление и доставка в Болгарию.',
        ],
      }
    : {
  ...
  return (
    ...
    >
      ...
      >
        {isRu
          ? 'Подпишитесь на наш Telegram-канал — свежие предложения и быстрая связь'
          : 'Join our Telegram channel for fresh deals and direct chat'}
      </div>

      {/* ── Telegram icon — 42 × 42, exactly 16 px BELOW the caption.
           (Was previously a Viber icon; Viber was retired in Dec 2026.) ── */}
      <div
        data-testid="mobile-telegram-icon"
        style={{
          position: 'absolute',
      ...
      >
        <a
          href="https://t.me/dm_auto"
          target="_blank"
          rel="noreferrer noopener"
          aria-label="Join our Telegram channel"
          data-testid="mobile-telegram-link"
          style={{
            width: 42,
            height: 42,
            display: 'inline-flex',
...
/* ─────────────────────────────────────────────────────────────────────
 * MobileWeHavePerfectService — v2 (Editorial Dark Process)
 *
 * Mirrors the new desktop FrameComponent24 design on mobile:
 *   • Deep navy gradient background with a diagonal amber beam.
 *   • Editorial title block (eyebrow + headline + intro).
 *   • Process metrics row (4 / 24-7 / 0).
 *   • 4 vertical "process cards" with big outline numerals, inline
 *     icons, amber tag chips and amber corner brackets.
 *
 * Copy was updated to the new product narrative — step 2 is now
 * "advance on customs arrival" and step 3 is "24/7 support" (the
 * legacy "real-time tracking" line does not match the actual offer).
 * ───────────────────────────────────────────────────────────────────── */

const PERFECT_SERVICE_STEP_ICONS = [
  /* 01 — Choose */ (
    <svg key="ps-icon-choose" viewBox="0 0 32 32" width="22" height="22" fill="none" aria-hidden="true"
  ...
  /* 02 — Customs */ (
    <svg key="ps-icon-customs" viewBox="0 0 32 32" width="22" height="22" fill="none" aria-hidden="true"
         stroke="currentColor" strokeWidth="1.6"
         strokeLinecap="round" strokeLinejoin="round">
      <path d="M6 27V12l10-6 10 6v15" />
      <path d="M3 27h26" />
      <path d="M11 27V17h10v10" />
      <path d="M16 6v6" />
      <path d="M14 9h4" />
    </svg>
  ),
  /* 03 — 24/7 support */ (
    <svg key="ps-icon-support" viewBox="0 0 32 32" width="22" height="22" fill="none" aria-hidden="true"
         stroke="currentColor" strokeWidth="1.6"
         strokeLinecap="round" strokeLinejoin="round">
  ...
  /* 04 — Keys */ (
    <svg key="ps-icon-keys" viewBox="0 0 32 32" width="22" height="22" fill="none" aria-hidden="true"
         stroke="currentColor" strokeWidth="1.6"
         strokeLinecap="round" strokeLinejoin="round">
...
function MobileWeHavePerfectService() {
  ...
  const L = isRu
    ? {
        ...
        intro:
          'Прозрачный маршрут к вашему автомобилю — без авансов вслепую. Каждый шаг виден изнутри, команда рядом 24/7.',
        metaA: { val: '4', label: 'ШАГА' },
        metaB: { val: '24 / 7', label: 'ПОДДЕРЖКА' },
        metaC: { val: '0', label: 'РИСКИ' },
        metaD: { val: '50+', label: 'ГОРОДОВ РФ + РБ' },
        steps: [
          {
            tag: '01 — Выбор',
            title: 'Выберите автомобиль',
            subtitle:
              'Подбираем варианты под ваш стиль, бюджет и задачи. Машина, которая подходит именно вам.',
          },
          {
            tag: '02 — Аванс',
            title: 'Внесите небольшой аванс',
            subtitle:
              'Чтобы зафиксировать сделку, вы платите только аванс — а не полную сумму. Никаких рисков на старте.',
          },
          {
            tag: '03 — Связь',
            title: 'Поддержка 24 / 7',
            subtitle:
              'Личный менеджер всегда на связи: сроки, документы, состояние авто — ответ за минуты.',
          },
          {
            tag: '04 — Финал',
            title: 'Оплата и ключи',
            subtitle:
              'Остаток вносите только когда автомобиль уже у вас. Передаём машину в руки и закрываем все документы.',
          },
        ],
      }
    : {
        ...
        intro:
          'A transparent route to your car — no blind deposits. You see every step from the inside, and our team stays with you 24/7.',
        metaA: { val: '4', label: 'STEPS' },
        metaB: { val: '24 / 7', label: 'SUPPORT' },
        metaC: { val: '0', label: 'RISK' },
        metaD: { val: '50+', label: 'RU + BY CITIES' },
        steps: [
          {
            tag: '01 — Pick',
            title: 'Choose your car',
            subtitle:
              'We curate options that match your style, budget and goals. The car that genuinely fits you.',
          },
          {
            tag: '02 — Deposit',
            title: 'Place a small deposit',
            subtitle:
              'We secure your order with just a small advance — not the full price. Zero risk at the start.',
          },
          {
            tag: '03 — Contact',
            title: '24 / 7 support',
            subtitle:
              'Your personal manager is one tap away — timing, docs, condition — answered within minutes.',
          },
          {
            tag: '04 — Final',
            title: 'Settle & take the keys',
            subtitle:
              'You only pay the balance once the car is physically with you. We hand the keys over and close every detail.',
          },
        ],
      };
  ...
  return (
    <section
      ...
      style={{
        position: 'relative',
        background:
          'radial-gradient(120% 90% at 90% -10%, #11264A 0%, #091831 55%, #050E1E 100%)',
        width: '100%',
        paddingTop: 72,
        paddingBottom: 80,
        paddingLeft: 22,
    ...
    >
      {/* Diagonal amber beam + soft grid for "different from the rest" mood */}
      <div
        aria-hidden="true"
        style={{
          position: 'absolute',
          ...
          height: '160%',
          background:
            'linear-gradient(115deg, transparent 42%, rgba(254,174,0,0.10) 48%, rgba(254,174,0,0.18) 50%, rgba(254,174,0,0.10) 52%, transparent 58%)',
      ...
      <div style={{ position: 'relative', zIndex: 1 }}>
        {/* ── Eyebrow row ── */}
        <div
          data-testid="mobile-perfect-service-eyebrow"
          style={{
            display: 'flex',
            alignItems: 'center',
            gap: 12,
        ...
        >
          <span
            aria-hidden="true"
            style={{ width: 28, height: 2, background: '#FEAE00' }}
          />
          <span>{L.eyebrow}</span>
          <span
            style={{
        ...
        >
          {[L.metaA, L.metaB, L.metaC, L.metaD].map((m, idx) => (
            <div
              key={idx}
              style={{
                flex: 1,
        ...
        >
          {STEPS.map((step, i) => (
            ...
            >
              {/* Big outlined numeral — smaller and offset so it can't
                  collide with title/icon. */}
              <span
                aria-hidden="true"
                style={{
                  position: 'absolute',
                  ...
                  letterSpacing: '-0.04em',
                  color: 'transparent',
                  WebkitTextStroke: '1.2px rgba(254,174,0,0.5)',
                  fontVariantNumeric: 'tabular-nums',
                  fontFamily: FONT,
                  pointerEvents: 'none',
                  userSelect: 'none',
              ...
              {/* Head row: tag with leading icon (icon INSIDE the pill,
                  no separate icon box that could overlap the numeral). */}
              <div
                style={{
                  display: 'flex',
                  alignItems: 'center',
              ...
              >
                ...
                >
                  ...
                  >
                    {/* Force the source SVG (declared 22×22) down to 14
                        via inline width/height override so it fits the
                        small pill cleanly. */}
                    {React.cloneElement(PERFECT_SERVICE_STEP_ICONS[i], {
                      width: 14,
                      height: 14,
                    })}
                  </span>
              ...
              {/* Foot rule — clean amber accent, flush with text edge. */}
              <span
                aria-hidden="true"
                style={{
                  position: 'relative',
                  ...
                  width: 32,
                  background:
                    'linear-gradient(90deg, #FEAE00 0%, rgba(254,174,0,0) 100%)',
                  borderRadius: 2,
                  opacity: 0.85,
                }}
              />
...
function MobileTurnkeyServices() {
  ...
  const CARDS = isRu
    ? [
        {
          ...
          title: 'ИМПОРТ',
          body:
            'Мы помогаем вам найти подходящий автомобиль в соответствии с вашим бюджетом, стилем и потребностями - занимаемся осмотром, покупкой и доставкой из Германии в Болгарию.',
        },
        {
          num: '2',
          title: 'АДАПТАЦИЯ К ЕВРОПЕЙСКИМ СТАНДАРТАМ',
          body:
            'Мы адаптируем автомобиль к стандартам ЕС и обеспечиваем его готовность к беспроблемной регистрации.',
        },
        {
          num: '3',
          title: 'РЕГИСТРАЦИЯ И СЕРТИФИКАЦИЯ',
          body:
            'Мы берем на себя полную регистрацию в Болгарии, включая ГИБДД, документы и транзитные номера — мы поддерживаем вас на каждом этапе.',
        },
        {
          num: '4',
          title: 'ФИНАНСИРОВАНИЕ',
          body:
            'Мы свяжем вас с TBI Bank и UniCredit Bulbank и проведем вас через процесс финансирования.',
        },
        {
          num: '5',
          title: 'РАСПОЛОЖЕНИЕ И ДОСТАВКА ЗАПЧАСТЕЙ',
          body:
            'Мы поставляем и заказываем качественные детали из Германии и ЕС, помогая вам экономить без компромиссов.',
        },
        {
          num: '6',
          title: 'АВТОСЕРВИС',
          body:
            'Все ремонтные и технические работы мы берем на себя через сервис проверенного партнера.',
        },
        {
          num: '7',
          title: 'ДЕТАЛИЗАЦИЯ И ЧИСТКА',
          body:
            'Мы предлагаем профессиональную внутреннюю и внешнюю чистку и реставрацию. Мы сделаем ваш автомобиль как новый.',
        },
        {
          num: '8',
          title: 'ДОСТАВКА НА ДОМ',
          body:
            'Организуем доставку автомобиля в любой город Болгарии. Вы получаете готовый к эксплуатации автомобиль прямо у вашей двери — никаких сложностей, никаких лишних поездок.',
        },
      ]
    : [
    {
      ...
      title: 'IMPORT',
      body:
        'We help you find the right car based on your budget, style, and needs - handling the inspection, purchase, and delivery from Germany to Bulgaria.',
    },
    {
      num: '2',
    ...
    },
    {
      ...
      body:
        'We source and order quality parts from Germany and EU, helping you save without compromise.',
    },
    {
      num: '6',
      title: 'AUTO SERVICE',
...
function MobileBeforeAndAfter({ items, activeIdx, setActiveIdx, t }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: '#162E51' }}>{t?.ourClientsReceive || 'Our clients receive'}</span>
        <br />
        <span style={{ color: '#17202A' }}>{t?.theBestService || 'the best service'}</span>
      </div>
...
function MobileOurClientsSay({ reviews, googleRating, googleReviewsCount, activeIdx, setActiveIdx, t }) {
  ...
  return (
    ...
    >
      ...
      >
        <span style={{ color: '#162E51' }}>{t?.satisfiedClients || 'Satisfied clients'}</span>
        <br />
        <span style={{ color: '#17202A' }}>{t?.areOurPriority || 'are our priority'}</span>
      </div>
      ...
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'flex-end', gap: 4 }}>
          ...
          <a
            href="https://g.page/r/dmauto/review"
            target="_blank"
...
/* ─────────────────────────────────────────────────────────────────────── */
/* MobileWhyPayLess (redesigned June 2026)                                 */
/*                                                                         */
/* Dark navy panel + UVP hero card + 5 advantage cards. Mirrors the new    */
/* desktop FrameComponent26 design (see frame-component26.module.css).     */
/* Brand tokens: navy #0F1F36, amber #FEAE00, cream #F5F0E8.               */
/* ─────────────────────────────────────────────────────────────────────── */
function MobileWhyPayLess() {
  ...
  const L = isRu
    ? {
        ...
        titleLine1: 'Плати меньше',
        titleLine2: '— получай больше',
        ...
        items: [
          { no: '01', title: 'Большой выбор',          body: 'Тысячи комплектаций, цветов и редких моделей, которых просто нет на местном рынке.' },
          { no: '02', title: 'Лучшие комплектации',    body: 'Больше опций, премиум-мультимедиа и более высокий уровень комфорта.' },
          { no: '03', title: 'Прозрачная история',     body: 'Полные отчёты по VIN (AutoDNA, Mobile.de) на каждый автомобиль до покупки.' },
          { no: '04', title: 'Значительно дешевле',    body: 'Даже с доставкой и таможней — на 20–50% ниже местного рынка.' },
        ],
      }
    : {
        ...
        items: [
          { no: '01', title: 'Wide selection',         body: 'Thousands of configurations, colors and rare trims unavailable on the local market.' },
          { no: '02', title: 'Best trim levels',       body: 'More options, premium multimedia and a higher level of comfort across every car.' },
          { no: '03', title: 'Transparent history',    body: 'Full VIN reports (AutoDNA, Mobile.de) attached to every car — see the past before you commit.' },
          { no: '04', title: 'Significantly cheaper',  body: 'Even with shipping and customs, the final price is 20–50% below the local market.' },
        ],
      };
  ...
  return (
    ...
    >
      {/* DM Auto brandmark \u2014 subtle, top-right of the block */}
      <img
        src="/figma/dm-auto-logo.png"
        alt="DM Auto"
        loading="lazy"
      ...
      <div style={{ position: 'relative', zIndex: 1, display: 'flex', flexDirection: 'column', gap: 36 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
          ...
          >
            <AnimatedHeading as="span" text={L.titleLine1} style={{ color: '#162E51', display: 'block' }} />
            <AnimatedHeading
              as="span"
              text={L.titleLine2}
              baseDelay={L.titleLine1.replace(/\s/g, '').length * 28}
              style={{ color: '#17202A', display: 'block' }}
            />
          </h2>
        </div>
        ...
        <article
          data-testid="mobile-why-pay-less-uvp"
          style={{
            position: 'relative',
            padding: '4px 0 4px 22px',
            borderLeft: '4px solid #FEAE00',
            display: 'flex',
            flexDirection: 'column',
            gap: 16,
          }}
        >
          ...
          >
            <span style={{ display: 'block', color: '#162E51' }}>{L.promiseTitle1}</span>
            <span style={{ display: 'block', color: '#17202A' }}>{L.promiseTitle2}</span>
          </h3>
          <p
            style={{
              margin: 0,
              ...
              >
                <span
                  ...
                  style={{
                    ...
                    borderRadius: '50%',
                    background: '#FEAE00',
                    boxShadow: '0 0 0 3px rgba(254, 174, 0, 0.22)',
                  }}
                />
                {b}
              </li>
        ...
        {/* 4 pull-quote advantages */}
        <ul
          data-testid="mobile-why-pay-less-list"
          style={{ listStyle: 'none', margin: 0, padding: 0, display: 'flex', flexDirection: 'column', gap: 22 }}
        >
          {L.items.map((it) => (
            <li
              key={it.no}
              data-testid={`mobile-why-pay-less-item-${it.no}`}
              style={{
                position: 'relative',
                padding: '20px 0 0',
                borderTop: '2px solid #162E51',
                display: 'flex',
                flexDirection: 'column',
                gap: 10,
              }}
            >
              ...
              <div style={{ display: 'flex', alignItems: 'baseline', gap: 8 }}>
                <span style={{ fontWeight: 700, fontSize: 12, letterSpacing: '0.18em', color: '#FEAE00' }}>
                  {it.no}
                </span>
                <span aria-hidden="true" style={{ fontWeight: 700, fontSize: 12, color: 'rgba(254, 174, 0, 0.55)' }}>
                  /
                </span>
              </div>
              <h4
