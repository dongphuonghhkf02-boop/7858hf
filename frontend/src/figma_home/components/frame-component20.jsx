 ...
 */
const VEHICLE_TYPES = [
  { id: "motorbike", icon: "/figma/calc/veh-motorbike.png", alt_en: "Motorbike", alt_ru: "Мотоцикл", apiType: "motorcycle" },
  { id: "sedan",     icon: "/figma/calc/veh-sedan.png",     alt_en: "Sedan",     alt_ru: "Седан",      apiType: "sedan" },
  { id: "suv",       icon: "/figma/calc/veh-suv.png",       alt_en: "SUV",       alt_ru: "Джип",       apiType: "suv" },
  { id: "pickup",    icon: "/figma/calc/veh-pickup.png",    alt_en: "Pick-up",   alt_ru: "Пикап",      apiType: "pickup" },
  { id: "van",       icon: "/figma/calc/veh-van.png",       alt_en: "Van",       alt_ru: "Ван",        apiType: "bigSUV" },
];
    ...
    >
      <div className={styles.frameParent} data-stagger="80" style={{ "--stagger-step": "120ms" }}>
        <div className={styles.frameGroup} data-stagger="80" style={{ "--stagger-step": "80ms" }}>
          ...
          <div className={styles.segment} role="tablist" aria-label={isRu ? "Вид транспорта" : "Vehicle type"}>
            {VEHICLE_TYPES.map(({ id, icon, alt_en, alt_ru }) => {
              const altLabel = isRu ? alt_ru : alt_en;
              return (
                <button
                  key={id}
                  type="button"
          ...
          <div className={styles.segment} role="tablist" aria-label={isRu ? "Ценовой диапазон" : "Price range"}>
            {PRICE_TIERS.map((p) => (
              <button
                key={p.label}
                type="button"
