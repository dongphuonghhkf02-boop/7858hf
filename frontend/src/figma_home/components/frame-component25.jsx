...
const T = {
  en: {
    ...
    import: "Import",
    importDesc:
      "We help you find the right car based on your budget, style, and needs - handling the inspection, purchase, and delivery from Europe to Belarus or Russia.",
    ...
    registrationDesc:
      "We handle full registration in Belarus or Russia, including all paperwork, documents, and transit plates - supporting you every step.",
    financing: "Financing",
    financingDesc:
      "We connect you with trusted partner banks and guide you through the financing process.",
    ...
    homeDeliveryDesc:
      "We arrange delivery of your vehicle to any city in Belarus or Russia. You receive a ready-to-drive car right at your doorstep — no hassle, no extra trips.",
    findACar: "find a car",
  },
  ru: {
    ...
    import: "Импорт",
    importDesc:
      "Мы помогаем вам найти подходящий автомобиль по вашему бюджету, стилю и потребностям - осуществляем осмотр, покупку и доставку из Европы в Беларусь или Россию.",
    euAdaptation: "Адаптация к европейским стандартам",
    euAdaptationDesc:
      "Мы адаптируем автомобиль под стандарты ЕС и гарантируем готовность к беспроблемной регистрации.",
    registration: "Регистрация и сертификация",
    registrationDesc:
      "Осуществляем полную регистрацию в Беларуси или России, включая все документы и транзитные номера – в вашем распоряжении на каждом этапе пути.",
    financing: "Финансирование",
    financingDesc:
      "Мы свяжем вас с проверенными банками-партнёрами и проведем вас через процесс финансирования.",
    partsSourcing: "Поиск и доставка запчастей",
    partsSourcingDesc:
    ...
    autoServiceDesc:
      "Все ремонтные и технические работы мы выполняем через сервис проверенного партнера.",
    detailing: "Детализация и чистка",
    detailingDesc:
      "Мы осуществляем профессиональную наружную и внутреннюю чистку и реставрацию. Мы заставим ваш автомобиль выглядеть и чувствовать себя как новый.",
    homeDelivery: "Доставка на дом",
    homeDeliveryDesc:
      "Организуем доставку автомобиля в любой город Беларуси или России. Вы получаете готовый к эксплуатации автомобиль – никакой головной боли и лишних поездок.",
