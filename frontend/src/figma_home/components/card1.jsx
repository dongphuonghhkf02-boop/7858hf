...
const T = {
  en: {
    ...
    engine: "Engine",
    drive: "Drive",
    estimatedFinalCostToBulgaria: "Estimated final cost (BY / RU):",
  ...
  ru: {
    ...
    engine: "Двигатель",
    drive: "Водить машину",
    estimatedFinalCostToBulgaria: "Ориентировочная итоговая цена (BY / RU):",
    ...
    closed: "Закрыто",
    shareCar: "Поделитесь автомобилем",
    addToCompare: "Добавить для сравнения",
    removeFromCompare: "Удалить из сравнения",
    addToFavorites: "Добавить в избранное",
    removeFromFavorites: "Удалить из избранного",
    pleaseLogin: "Пожалуйста, войдите, чтобы сохранить в избранное",
    compareFull: "Список сравнения полный (максимум 3). Сначала удалите один.",
    addedToFavorites: "Добавлено в избранное",
    removedFromFavorites: "Удалено из избранного",
    addedToCompare: "Добавлено для сравнения",
    addedToCompareNeedMore: "Добавьте хотя бы еще 1 автомобиль, чтобы начать сравнение",
    compareReadyTitle: "Готов сравнить!",
    compareReadyDesc: "Выбрано 2 автомобиля – открытое сравнение",
    compareFullTitle: "Список сравнения завершен (3/3)",
    compareFullDesc: "Откройте сравнение или удалите автомобиль, чтобы добавить другой.",
    openCompareBtn: "Открытое сравнение",
    removedFromCompare: "Удален из сравнения",
    couldNotUpdateFavorites: "Нам не удалось обновить избранное",
    couldNotUpdateCompare: "Нам не удалось обновить сравнение.",
  },
};
